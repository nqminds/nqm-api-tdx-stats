module.exports = (function() {
  ...
  const getMinChunk = function(datasetId, params) {

  };

  const getMaxChunk = function(datasetId, params) {

  };

  const getSumChunk = function(datasetId, params) {

  };

  const getAvgChunk = function(datasetId, params) {

  };

  const getStdChunk = function(datasetId, params) {

  };

  const getMedChunk = function(datasetId, params) {
