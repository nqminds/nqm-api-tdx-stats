module.exports = (function() {
  ...
  function getIterator(datasetId, params) {
    ...
    const funcParams = {datasetId: datasetId, params: params};
    let iterator;

    // Create a new iterator object
    if (!params.index.length || !size)
      iterator = new ChunkIterator(indexCallFunction, funcParams, baseChangeFunction);
    else
