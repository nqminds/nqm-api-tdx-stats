module.exports = (function() {
  ...
  // Gets the value of the parameter for the functions used inside the _callFunc
  const getFuncParam = function(key) {
    return this._funcParams[key];
  };
  ...
  function ChunkIterator(changeFunction, callFunction, funcParams, groupFunc) {
    ...
    this.getFuncParam = getFuncParam;
